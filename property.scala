...
//https://databricks-prod-cloudfront.cloud.databricks.com/public/4027ec902e239c93eaaa8714f173bcfc/5996310910311000/2894282466980681/2803807529895173/latest.html

// COMMAND ----------

// MAGIC %python
// MAGIC # File location and type
// MAGIC file_location = "/FileStore/tables/Property_data-1.csv"
// MAGIC file_type = "csv"
// MAGIC 
// MAGIC # CSV options
...
// MAGIC 
// MAGIC temp_table_name = "Property_data-1_csv"
// MAGIC 
...
// MAGIC 
// MAGIC select * from `Property_data-1_csv`
...
// MAGIC 
// MAGIC permanent_table_name = "Property_data-1_csv"
// MAGIC 
// MAGIC # df.write.format("parquet").saveAsTable(permanent_table_name)

// COMMAND ----------

val data = sc.textFile("/FileStore/tables/Property_data-1.csv")
