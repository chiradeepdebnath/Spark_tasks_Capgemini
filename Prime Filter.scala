...
// MAGIC %python
// MAGIC val header=data.first
// MAGIC val withoutheader=data.filter(line=>line!=header)
// MAGIC withoutheader.collect
// MAGIC val intdata=withoutheader.map(line=>line.toInt)
// MAGIC intdata.collect()
